...
// JSMSEMI  MFRC522 (0x92)
const byte MFRC522_JSMSEMI_firmware_reference[] PROGMEM = {
	0x00, 0xEB, 0x66, 0xBA, 0x57, 0xBF, 0x23, 0x95,
	0xD0, 0xE3, 0x0D, 0x3D, 0x27, 0x89, 0x5C, 0xDE,
	0x9D, 0x3B, 0xA7, 0x00, 0x21, 0x5B, 0x89, 0x82,
	0x51, 0x3A, 0xEB, 0x02, 0x0C, 0xA5, 0x00, 0x49,
...
public:
	...
	void PICC_DumpMifareUltralightToBuffer(byte* ultralightData);
	//void PICC_DumpMifareUltralightToEthernet();
